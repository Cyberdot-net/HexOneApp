...
export default function Stats() {
  ...
  useEffect(() => {
    ...
    const getData = async () => {
      ...
      const sacrificeData = await HexOneBootstrap.sacrificeInfos();
      let sumUSD = BigNumber.from(0),
        sumHex = BigNumber.from(0),
        sumWpls = BigNumber.from(0),
        sumPlsx = BigNumber.from(0),
        sumDai = BigNumber.from(0);
      ...
      {
        ERC20Contract.setProvider(
          provider,
          "0xefD766cCb38EaF1dfd701853BFCe31359239F305"
        );
        const res = await ERC20Contract.getBalance(
          "0x9b366950446E94A6D8D2ae81B2bb751dC91495E9"
        );
      }
    ...
    <div className="wrapper">
      <section className="section section-lg section-titles">
        <div style={{ color: "white", fontSize: "16px", paddingTop: "50px" }}>
          ...
          <div>
            Total Hexit for staking(Not distributed): {hexitNotDistributed}
          </div>
